...
import { useGetGem, useGetRelatedGems, useLogin } from "@/api-client";
...
import { ShieldCheck, MapPin, Share2, Plus, Minus, ShoppingBag, Loader2 } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 mb-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4 border-t border-border pt-6 mt-auto">
              ...
              <button className="text-muted-foreground hover:text-primary transition-colors"><FaFacebook className="h-4 w-4" /></button>
              <button className="text-muted-foreground hover:text-primary transition-colors"><FaTwitter className="h-4 w-4" /></button>
            </div>
          </div>
        </div>
